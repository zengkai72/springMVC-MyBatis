...
/**
 * @Description :异常增强，以JSON的形式返回给客服端
 ...
 * @Author: Zengkai
 * @Date: Created On 17:09  2017/6/4.
...
public class RestExceptionHandler {
    ...
    @ResponseBody
    public String customExceptionHandler(CustomExption customExption) {
            Integer status =  customExption.getStatus();
        return ReturnFormat.retParam(status, null);
    }
