...
import com.kai.common.utils.propertyUtil.PropertyUtil;
...
/**
 * @Description :格式化返回客户端数据格式（json）
 * @Author: Zengkai
 * @Date: Created On 17:12  2017/6/4.
...
public class ReturnFormat {
    ...
    public static String retParam(Integer status,Object data) {
        String message = PropertyUtil.getProperty(status.toString());
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        OutputJson json = new OutputJson(status, message, data,sdf.format(new Date()));
